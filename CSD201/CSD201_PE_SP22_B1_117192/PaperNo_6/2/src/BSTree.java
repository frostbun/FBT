...
//===========================================================================
    void insert(String xTower, int xSound, int xType) {
        ...
        Node walk = root;
        while (walk.info.sound != node.info.sound) {
            if (node.info.sound < walk.info.sound) {
                if (walk.left == null) {
                    walk.left = node;
                    return;
                }
...
//=============================================================
    ...
    void inorder(Node n, List<Node> visited) {
        if (n == null) return;
    ...
    void inorder(Node r) {
        ...
        Node n = visited.get(3);
        visited = new ArrayList<>();
        inorder(n, visited);
        n.info.type = visited.size();
    }
